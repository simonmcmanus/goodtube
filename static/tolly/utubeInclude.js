...
ytvb.appendVideoDataToTable = function(tbody, entry, entryIndex) {
  ...
  tr.onclick = ytvb.generatePlayVideoLinkOnclick(entry.id.$t, entryIndex, ytvb.REFERRING_FEED_TYPE_MAIN);
 var thumbnailTd = document.createElement('td');
  ...
  var metadataDefragLink = document.createElement('a');
  metadataDefragLink.innerHTML = 'defrag';
  metadataDefragLink.setAttribute('href', '#'); 
  metadataDefragLink.onclick = function() {
console.log('this is ', this); 
  ...
  metadataTd.appendChild(metadataDefragLink);
...
function onYouTubePlayerReady(playerId) {
  ...
  ytplayer.addEventListener("onError", "onPlayerError");
    ...
    ytvb.appendScriptTag("http://gdata.youtube.com/feeds/api/videos/"+tolly.id+"/related?a=1", 
...
// THIS HAS BEEN OVERRIDDEN BELOW.
